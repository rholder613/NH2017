/* NetHack 3.6	uwpdeviceresources.cpp	$NHDT-Date:  $  $NHDT-Branch:  $:$NHDT-Revision:  $ */
...
std::shared_ptr<DX::DeviceResources> DX::DeviceResources::s_deviceResources;
...
void DX::DeviceResources::CreateDeviceResources() 
{
    ...
    // TODO(bhouse) Change back to usnig LESS and use appropriate z values to render
    //              dialogs above main windows instead of painters algorithm.
    ...
    DX::ThrowIfFailed(
        m_d3dDevice->CreateDepthStencilState(
            &depthState, &m_d3dDepthStencilState));
}
